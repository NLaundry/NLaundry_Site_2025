...
export const GLOBAL = {
    // Site metadata
    username: "Nathan Laundry",
    rootUrl: "https://nathanlaundry.com",
    shortDescription: "On Life and Lab",
    ...
    poetryShortDescription: "Practical wisdom, unfiltered thoughts, and hot takes.",
    poetryLongDescription: "Web development, tech trends, and the occasional programming mishap.",
    
    // publication metadata
    publicationTitle: "My Thoughts & Takes",
    publicationShortDescription: "Practical wisdom, unfiltered thoughts, and hot takes.",
    publicationLongDescription: "Web development, tech trends, and the occasional programming mishap.",
